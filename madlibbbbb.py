...
def madlib_story_1():
    ...
    madlib = f"{noun} is a {adjective} {plural_noun} that grows on your {part_of_body}. If you don't remove it in {number} days, it will spread to your {place}, making it difficult for {verb_ing}."
    print(madlib)
...
def choose_story():
    title_options = [
        "Welcome to Madlibs Mania - Where imagination and humour collide!",
